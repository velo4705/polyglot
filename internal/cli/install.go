...
func installLanguage(cmd *cobra.Command, args []string) error {
	...
	langMap := map[string]struct {
		...
		"purs":            {"PureScript", "spago"},
		"roc":             {"Roc", "roc"},
		"v":               {"V", "v"},
		"odin":            {"Odin", "odin"},
		"nasm":            {"NASM", "nasm"},
		"gas":             {"GAS", "gcc"},
		"arm":             {"ARM Assembly", "arm-linux-gnueabi-gcc"},
		"arm-assembly":    {"ARM Assembly", "arm-linux-gnueabi-gcc"},
		"mips":            {"MIPS Assembly", "mips-linux-gnu-gcc"},
		"mips-assembly":   {"MIPS Assembly", "mips-linux-gnu-gcc"},
		"riscv":           {"RISC-V Assembly", "riscv64-linux-gnu-gcc"},
		"riscv-assembly":  {"RISC-V Assembly", "riscv64-linux-gnu-gcc"},
	}
